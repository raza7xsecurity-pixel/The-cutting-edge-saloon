...
EMAIL_PASSWORD = "xqgtgspifscvxosd" # THIK KIYA: direct password daala

# ====== META WHATSAPP KEYS ======
WHATSAPP_TOKEN = None # Baad me dalenge
PHONE_NUMBER_ID = None # Baad me dalenge
  ...
  <div class="wrap">
    ...
    <div class="svc-grid">
      ...
      <div class="svc-category">
        ...
        <div class="svc-item"><span>O3+ Cleanup</span><span class="svc-price">₹1399</span></div> <!-- THIK KIYA: 11s99 -> 1399 -->
...
def send_email(name, phone, service, date, time): # THIK KIYA: indentation
    msg = EmailMessage()
    msg.set_content(f"""🔔 NEW BOOKING RECEIVED - THE CUTTING EDGE
