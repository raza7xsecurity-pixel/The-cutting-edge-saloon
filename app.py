...
# IMPORTANT: Never hardcode passwords in code. Set these as environment
# variables on your server / hosting platform instead:
...
<footer id="contact">
  <div class="wrap">
    ...
    <div class="foot-bottom">©️ 2026 THE CUTTING EDGE GENTS SALON. LUXURY REDEFINED.</div>
  </div>
</footer>
...
<script>
  ...
  document.getElementById('booking-form').addEventListener('submit', async (e)=>{
    ...
    try {
      ...
      alert('Sorry, something went wrong while booking. Please try again or call us directly.');
...
def book():
    ...
    try:
        ...
        # Notifications failing shouldn't break the booking confirmation for the user
